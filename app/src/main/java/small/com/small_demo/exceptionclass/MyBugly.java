package small.com.small_demo.exceptionclass;
...
public class MyBugly implements Thread.UncaughtExceptionHandler {
    private static MyBugly myBugly = null;
    ...
    public static MyBugly getMyBugly() {
        if (myBugly == null) {
            synchronized (MyBugly.class) {
                myBugly = new MyBugly();
            }
        }
        return myBugly;
